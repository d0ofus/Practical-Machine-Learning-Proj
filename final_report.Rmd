...
Tthere are 160 variables and 19622 observations in the training set, while 20 for the test set.
...
After removing the unnecessary variables from the training set, the next step is to split it into two subsets: a **validation** set and a **training** set. The testing set, "testcsv", will be kept separate and used exclusively for the final quiz test cases.
```{r}
...
Here we will test a few popular models including: **Decision Trees**, **Random Forest**, **Gradient Boosted Trees**.
